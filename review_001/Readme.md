###  REVIEW 1 ( Introducción a PostgreSQL e Instalación).

### DESCRIPCIÓN.
- En este primer dia de aprendizaje se aprendieron los principios de `Postgresql` y sus principales ventajas y dominaciones.

### REQUERIMOTOS DEL EJERCICIO 1.
## SELECT
